...
//zırhlar
	...
	if o_rogue.equipment_helmet == 1 {
		sprite_index = s_pacavra_head;
	}
	if o_rogue.equipment_helmet == 0 {
		sprite_index = s_body_head_rogue;
...
// burada or room == Room_character_skills  böyle bir kod vardı bunu silince invbodylerin savaşta iken ekrana çıkması giderildi ilerideki sorunlara bu sebep olabilir.
