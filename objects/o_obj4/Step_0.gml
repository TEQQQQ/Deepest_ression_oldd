...
if position_meeting(mouse_x,mouse_y,o_obj4){
	if o_obj1.gorunum == false and o_obj3.gorunum == false and o_obj2.gorunum == false {
		global.text_info = false;
		global.text_main = false;
		global.text_obj1 = false;
		global.text_obj2 = false;
		global.text_obj3 = false;
		global.text_obj4 = true;
		if number_ == 1 {
			sprite_index = s_background_necklace2
		} else {
			//image_index = 1;	
		}
