...
if room == Room_info or room == Room1 {
	...
	if position_meeting(mouse_x,mouse_y,o_rogue_earring_emerald_inv2){
			...
			if hareket == false {
				if mouse_check_button_pressed(mb_right){
					if in_equipment == false {
						if o_rogue.equipment_earring_1 == 0 {
							o_rogue.equipment_earring_1 = 1;
							in_equipment = true;
						...
						} else if o_rogue.equipment_earring_2 == 0 {
								o_rogue.equipment_earring_2 = 1;
								in_equipment = true;
						...
						if o_inventory.place_1 == true {
							...
							if position_meeting(mouse_x,mouse_y,o_inventory_place_earring) {
								o_inventory.place_earring_1 = true;
								o_rogue.equipment_earring_1 = 0;
								
							}
							
							if position_meeting(mouse_x,mouse_y,o_inventory_place_earring_2) {
								o_inventory.place_earring_2 = true;
	...
	if hareket == false and global.mouse_item == 0 {
		...
		if position == 26 {
			x = o_inventory_place_earring.x;
			y = o_inventory_place_earring.y;	
		}
		if position == 27 {
			x = o_inventory_place_earring_2.x;
			y = o_inventory_place_earring_2.y;	
		}
	}
