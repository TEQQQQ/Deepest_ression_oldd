...
if o_rogue.defence_resisting_1_3_on == true {
	...
	if instance_exists(o_defence_buff){
		if previous_count < o_defence_buff.previous_count {
			o_defence_buff.previous_count -=1;
		}
	}
...
if once == true {
	if !instance_exists(o_rogue_defence_1_3_effect){
		instance_create_layer(o_border_player.x,o_border_player.y,"effects",o_rogue_defence_1_3_effect);	
		once = false;
	}
}
