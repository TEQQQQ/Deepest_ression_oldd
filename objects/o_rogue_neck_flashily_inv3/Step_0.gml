...
if room == Room_info or room == Room1 {
	...
	if position_meeting(mouse_x,mouse_y,o_rogue_neck_flashily_inv3){
			...
			if hareket == false {
				if mouse_check_button_pressed(mb_right){
					if in_equipment == false {
						if o_rogue.equipment_neck == 0 {
							o_rogue.equipment_neck = 1;
							in_equipment = true;
						...
						if o_inventory.place_1 == true {
							...
							o_inventory.place_neck = true;
							o_rogue.equipment_neck = 0;
							position = 1;
							in_equipment = false;
	...
	if hareket == false and global.mouse_item == 0 {
		...
		if position == 25 {
			x = o_inventory_place_neck.x;
			y = o_inventory_place_neck.y;	
		}
	}
