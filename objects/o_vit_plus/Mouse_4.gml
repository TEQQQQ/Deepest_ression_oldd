...
if global.character == 4 {
	if o_rogue.stat_points >= 1 {
		...
		o_rogue.max_hp += 30
		//o_rogue.max_hp += 30+(o_rogue.max_hp*2)/100;
...
if global.character == 3 {
	if o_mage.stat_points >= 1 {
		...
		// 50+%1=yenican
		o_mage.max_hp += 50+(o_mage.max_hp*1)/100;
	}
}
...
if global.character == 1 {
	if o_knight.stat_points >= 1 {
		...
		// 50+%4=yenican
		o_knight.max_hp += 50+(o_knight.max_hp*4)/100;
	}
}
...
if global.character == 2 {
	if o_priest.stat_points >= 1 {
		...
		// 20+%3=yenican
		o_priest.max_hp += 20+(o_priest.max_hp*3)/100;
	}
}
