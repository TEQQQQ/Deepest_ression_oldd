...
if !instance_exists(o_skill_bandicot_bite){
	instance_create_layer(514,315,"Instances",o_skill_bandicot_bite);	
}
...
if o_skill_bandicot_bite.vurus == false {
	act_time++;
	if zeka == 1 {
		
		if act_time == 25 {	
			o_skill_bandicot_bite.vurus = true;
...
if hp <= 0 {
	...
	instance_destroy(o_skill_bandicot_bite);
}
