...
if !instance_exists(o_skill_souleater_consume){
	instance_create_layer(514,315,"Instances",o_skill_souleater_consume);	
}
...
if o_skill_souleater_consume.vurus == false {
	act_time++;
	if zeka == 1 {
		
		if act_time == 25 {	
			o_skill_souleater_consume.vurus = true;
						...
						if (2*(bleed_damage-(o_rogue.armor/5)) > 0) {
							if o_rogue.defence_resisting_1_3_on == true {
								if o_rogue.defence_resisting_1_3 == 4 {
									...
									// pasifi gereği vurduğunun 2 katı bleed can alması için gereken kod
									hp += 2*(2*ceil((bleed_damage-(o_rogue.armor/5))));
									///
						...
						if ((bleed_damage-(o_rogue.armor/5)) > 0) {
							if o_rogue.defence_resisting_1_3_on == true {
								if o_rogue.defence_resisting_1_3 == 4 {
									...
									// pasifi gereği vurduğunun 2 katı bleed can alması için gereken kod
									hp += 2*ceil((bleed_damage-(o_rogue.armor/5)));
									///
...
if hp <= 0 {
	...
	instance_destroy(o_skill_souleater_consume);
}
