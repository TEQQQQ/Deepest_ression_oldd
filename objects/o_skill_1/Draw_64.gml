...
if global.text_info == true {
	...
	if room == Room_character_skills {
		draw_text_transformed(x,y," "+string(key),0.05,0.05,0);	
		draw_text_transformed(250,250," "+string(sprite_index),0.05,0.05,0);	
	}
	...
	if room == Room1 {
		//draw_text_transformed(x,y+10," "+string(hurting_deger),0.05,0.05,0);	
		draw_text_transformed(x,y," "+string(key),0.05,0.05,0);	
		draw_text_transformed(x,y-50," "+string(o_rogue.armor),0.05,0.05,0);	
		draw_text_transformed(x+200,y-50," "+string(o_rogue.health_potion_100),0.05,0.05,0);
		draw_text_transformed(x+50,y-50," "+string(time),0.05,0.05,0);
