...
if room == Room_info or room == Room1 {
	...
	if position_meeting(mouse_x,mouse_y,o_rogue_sunknight_pants_inv5){
				...
				if mouse_check_button_pressed(mb_right){
					if in_equipment == false {
						...
						if o_inventory.place_1 == true {
							...
							o_inventory.place_pants = true;
							o_rogue.equipment_pants = 0;
							position = 1;
							in_equipment = false;
	...
	if hareket == false and global.mouse_item == 0 {
		...
		if position == 19 {
			x = o_inventory_place_pants.x;
			y = o_inventory_place_pants.y;	
		}
	}
