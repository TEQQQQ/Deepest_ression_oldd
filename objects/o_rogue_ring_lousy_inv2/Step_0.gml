...
if room == Room_info or room == Room1 {
	...
	if position_meeting(mouse_x,mouse_y,o_rogue_ring_lousy_inv2){
				...
				if mouse_check_button_pressed(mb_right){
					if in_equipment == false {
						if o_rogue.equipment_ring_1 == 0 {
							o_rogue.equipment_ring_1 = 2;// bu value itemin hangi item olduğunu belirtmek için elzem
							in_equipment = true;
						...
						if o_inventory.place_1 == true {
							...
							if position_meeting(mouse_x,mouse_y,o_inventory_place_ring) {
								o_inventory.place_ring_1 = true;
								o_rogue.equipment_ring_1 = 0;
								
							}
							
							if position_meeting(mouse_x,mouse_y,o_inventory_place_ring_2) {
								o_inventory.place_ring_2 = true;
								o_rogue.equipment_ring_2 = 0;
	...
	if hareket == false and global.mouse_item == 0 {
		...
		if position == 22 {
			x = o_inventory_place_ring.x;
			y = o_inventory_place_ring.y;	
		}
		if position == 23 {
			x = o_inventory_place_ring_2.x;
			y = o_inventory_place_ring_2.y;	
		}
	}
