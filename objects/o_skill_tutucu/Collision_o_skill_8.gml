...
if o_skill_tutucu.sprite_index == s_skill_1 {
	...
	if o_skill_8.hareket == true {
		if mouse_check_button_pressed(mb_left){
			instance_destroy(o_hint_skill_info_11);
			instance_destroy(o_skill_select);
			sprite_index = o_skill_8.sprite_index;
			o_skill_8.sprite_index = s_skill_1;
			o_skill_tutucu.hurting_deger = o_skill_8.hurting_deger;
			o_skill_tutucu.resisting_deger = o_skill_8.resisting_deger;
			o_skill_tutucu.thievery_deger = o_skill_8.thievery_deger;
			o_skill_tutucu.potion_deger = o_skill_8.potion_deger;
			o_skill_8.potion_deger = 0;
			o_skill_8.hurting_deger = 0;
			o_skill_8.resisting_deger = 0;
			o_skill_8.thievery_deger = 0;
			o_skill_8.hareket = false;
			global.skill = 0;
		}
	}
