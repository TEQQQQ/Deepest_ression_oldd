...
if o_skill_tutucu.sprite_index == s_skill_1 {
	...
	if o_skill_6.hareket == true {
		if mouse_check_button_pressed(mb_left){
			...
			o_skill_tutucu.hurting_deger = o_skill_6.hurting_deger;
			o_skill_tutucu.resisting_deger = o_skill_6.resisting_deger;
			o_skill_tutucu.thievery_deger = o_skill_6.thievery_deger;
			o_skill_tutucu.potion_deger = o_skill_6.potion_deger;
