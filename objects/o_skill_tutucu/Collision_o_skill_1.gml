...
if o_skill_tutucu.sprite_index == s_skill_1 {
	...
	if o_skill_1.hareket == true {
		if mouse_check_button_pressed(mb_left){
			...
			sprite_index = o_skill_1.sprite_index;
			o_skill_1.sprite_index = s_skill_1;
			o_skill_tutucu.hurting_deger = o_skill_1.hurting_deger;
			o_skill_tutucu.resisting_deger = o_skill_1.resisting_deger;
			o_skill_tutucu.thievery_deger = o_skill_1.thievery_deger;
			o_skill_tutucu.potion_deger = o_skill_1.potion_deger;
...
if hareket == true {
	if position_meeting(mouse_x,mouse_y,o_skill_1){
