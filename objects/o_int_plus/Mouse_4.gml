...
if global.character == 4 {
	if o_rogue.stat_points >= 1 {
		...
		/*
		o_rogue.bleed_resistance += (o_rogue.bleed_resistance*2)/100;
		o_rogue.poison_resistance +=(o_rogue.poison_resistance*2)/100;
		o_rogue.flame_resistance += (o_rogue.flame_resistance*2)/100;
		o_rogue.glacier_resistance += (o_rogue.glacier_resistance*2)/100;
		o_rogue.electro_resistance += (o_rogue.electro_resistance*2)/100;
		*/
...
if global.character == 3 {
	if o_mage.stat_points >= 1 {
		...
		//luck = 2 resistance = %4
		o_mage.luck += 2
		o_mage.bleed_resistance += (o_mage.bleed_resistance*4)/100;
		o_mage.poison_resistance +=(o_mage.poison_resistance*4)/100;
		o_mage.flame_resistance += (o_mage.flame_resistance*4)/100;
		o_mage.glacier_resistance += (o_mage.glacier_resistance*4)/100;
		o_mage.electro_resistance += (o_mage.electro_resistance*4)/100;
	}
}
...
if global.character == 1 {
	if o_knight.stat_points >= 1 {
		...
		//luck = 2 resistance = %1
		o_knight.luck += 2
		o_knight.bleed_resistance += (o_knight.bleed_resistance*1)/100;
		o_knight.poison_resistance +=(o_knight.poison_resistance*1)/100;
		o_knight.flame_resistance += (o_knight.flame_resistance*1)/100;
		o_knight.glacier_resistance += (o_knight.glacier_resistance*1)/100;
		o_knight.electro_resistance += (o_knight.electro_resistance*1)/100;
	}
}
...
if global.character == 2 {
	if o_priest.stat_points >= 1 {
		...
		//luck = 2 resistance = %3
		o_priest.luck += 2
		o_priest.bleed_resistance += (o_priest.bleed_resistance*3)/100;
		o_priest.poison_resistance +=(o_priest.poison_resistance*3)/100;
		o_priest.flame_resistance += (o_priest.flame_resistance*3)/100;
		o_priest.glacier_resistance += (o_priest.glacier_resistance*3)/100;
		o_priest.electro_resistance += (o_priest.electro_resistance*3)/100;
	}
}
