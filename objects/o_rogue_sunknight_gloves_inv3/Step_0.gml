...
if room == Room_info or room == Room1 {
	...
	if position_meeting(mouse_x,mouse_y,o_rogue_sunknight_gloves_inv3){
				...
				if mouse_check_button_pressed(mb_right){
					if in_equipment == false {
						...
						if o_inventory.place_1 == true {
							...
							o_inventory.place_gloves = true;
							o_rogue.equipment_gloves = 0;
							position = 1;
							in_equipment = false;
	...
	if hareket == false and global.mouse_item == 0 {
		...
		if position == 21 {
			x = o_inventory_place_gloves.x;
			y = o_inventory_place_gloves.y;	
		}
	}
