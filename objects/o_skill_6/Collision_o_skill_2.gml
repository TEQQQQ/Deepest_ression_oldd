...
if o_skill_6.sprite_index == s_skill_1 {
	...
	if o_skill_2.hareket == true {
		if mouse_check_button_pressed(mb_left){
			...
			o_skill_6.hurting_deger = o_skill_2.hurting_deger;
			o_skill_6.resisting_deger = o_skill_2.resisting_deger;
			o_skill_6.thievery_deger = o_skill_2.thievery_deger;
			o_skill_6.potion_deger = o_skill_2.potion_deger;
