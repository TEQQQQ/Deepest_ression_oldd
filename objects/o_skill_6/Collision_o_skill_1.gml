...
if o_skill_6.sprite_index == s_skill_1 {
	...
	if o_skill_1.hareket == true {
		if mouse_check_button_pressed(mb_left){
			...
			o_skill_6.hurting_deger = o_skill_1.hurting_deger;
			o_skill_6.resisting_deger = o_skill_1.resisting_deger;
			o_skill_6.thievery_deger = o_skill_1.thievery_deger;
			o_skill_6.potion_deger = o_skill_1.potion_deger;
