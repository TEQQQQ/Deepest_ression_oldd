...
if o_skill_7.sprite_index == s_skill_1 {
	...
	if o_skill_4.hareket == true {
		if mouse_check_button_pressed(mb_left){
			...
			o_skill_7.hurting_deger = o_skill_4.hurting_deger;
			o_skill_7.resisting_deger = o_skill_4.resisting_deger;
			o_skill_7.thievery_deger = o_skill_4.thievery_deger;
			o_skill_7.potion_deger = o_skill_4.potion_deger;
