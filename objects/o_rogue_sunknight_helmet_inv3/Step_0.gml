...
if room == Room_info or room == Room1 {
	...
	if position_meeting(mouse_x,mouse_y,o_rogue_sunknight_helmet_inv3){
			...
			if hareket == false {
				if mouse_check_button_pressed(mb_right){
					if in_equipment == false {
						if o_rogue.equipment_helmet == 0 {
							o_rogue.equipment_helmet = 3;
							in_equipment = true;
							// konumlar kaska takmak için
							if position == 1 {
								position = 17;
						...
						//kafalık takılı ise sağ tıklayınca ne olacağı
						if o_inventory.place_1 == true {
							x = o_inventory_place_1.x;
							y = o_inventory_place_1.y;
							o_inventory.place_1 = false;
							o_inventory.place_helmet = true;
							o_rogue.equipment_helmet = 0;
							position = 1;
							in_equipment = false;
	...
	if hareket == false and global.mouse_item == 0 {
		...
		if position == 17 {
			x = o_inventory_place_helmet.x;
			y = o_inventory_place_helmet.y;	
		}
	}
