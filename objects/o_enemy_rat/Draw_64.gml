...
draw_sprite_stretched(s_health_enemy,0,healthbar_x-69,healthbar_y-5,min((hp/max_hp)* healthbar_width,healthbar_width),healthbar_height);
//draw_sprite(s_healthbar_enemy,0,healthbar_x,healthbar_y);
...
draw_sprite_stretched(s_mana_enemy,0,manabar_x-43,manabar_y-5,min((mana/max_mana)* manabar_width,manabar_width),manabar_height);
